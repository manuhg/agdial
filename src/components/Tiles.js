...
class Tiles extends Component
{
    render()
    {
        ...
        var cardImgStyle=
        {paddingLeft:'15px', maxHeight:'100%',maxWidth:'100%',objectFit:'contain'};
        return(
                                        ...
                                        <div className="zp card tiles">
                                            <div style={{display:'flex'}} className="zp card-horizontal row">
                                                ...
                                                <div  style={{flex:'1'}} className="zp card-body col-7">
                                                    ...
                                                    {data[d].map((e,i)=><span style={{wordWrap:'break-word !important'}} key={i}>
                                                    ->&nbsp;{e.trim()}<br/></span>)}</div>
                                                </div>
                                            </div>
                                        </div>
...
export default Tiles;
 ...
 {/* <Container fluid>
            <Row  style={{display:'flex', width: '100%'}}>
                ...
                <img style={cardImgStyle} src={amimg} alt={d}/>
                <CardImage style={cardImgStyle} src={amimg} overlay="white-slight" hover waves alt={d}></CardIm
                </Col>
                <Col style={{flex:'1',padding:'1em'}} xs="6" sm="6" md="6" >
